module Translatable.Html.Events exposing
...
import Translatable.Html.Internal as I exposing (Attribute(..))
...
{-| -}
onClick : msg -> Attribute userText msg
onClick msg =
    on "click" (Json.succeed msg)


{-| -}
onDoubleClick : msg -> Attribute userText msg
onDoubleClick msg =
    on "dblclick" (Json.succeed msg)


{-| -}
onMouseDown : msg -> Attribute userText msg
onMouseDown msg =
    on "mousedown" (Json.succeed msg)


{-| -}
onMouseUp : msg -> Attribute userText msg
onMouseUp msg =
    on "mouseup" (Json.succeed msg)


{-| -}
onMouseEnter : msg -> Attribute userText msg
onMouseEnter msg =
    on "mouseenter" (Json.succeed msg)


{-| -}
onMouseLeave : msg -> Attribute userText msg
onMouseLeave msg =
    on "mouseleave" (Json.succeed msg)


{-| -}
onMouseOver : msg -> Attribute userText msg
onMouseOver msg =
    on "mouseover" (Json.succeed msg)


{-| -}
onMouseOut : msg -> Attribute userText msg
onMouseOut msg =
...
-}
onInput : (String -> msg) -> Attribute userText msg
onInput tagger =
...
-}
onCheck : (Bool -> msg) -> Attribute userText msg
onCheck tagger =
...
-}
onSubmit : msg -> Attribute userText msg
onSubmit msg =
...
{-| -}
onBlur : msg -> Attribute userText msg
onBlur msg =
    on "blur" (Json.succeed msg)


{-| -}
onFocus : msg -> Attribute userText msg
onFocus msg =
...
-}
on : String -> Json.Decoder msg -> Attribute userText msg
on event decoder =
    Event event (decoder |> Json.map (\msg -> I.Event_ msg False False))
...
-}
stopPropagationOn : String -> Json.Decoder ( msg, Bool ) -> Attribute userText msg
stopPropagationOn event decoder =
    Event event (decoder |> Json.map (\( msg, stopPropagation ) -> I.Event_ msg stopPropagation False))
...
-}
preventDefaultOn : String -> Json.Decoder ( msg, Bool ) -> Attribute userText msg
preventDefaultOn event decoder =
    Event event (decoder |> Json.map (\( msg, preventDefault ) -> I.Event_ msg False preventDefault))
...
-}
custom : String -> Json.Decoder { message : msg, stopPropagation : Bool, preventDefault : Bool } -> Attribute userText msg
custom =
    Event
...
keyboard listeners like this:
    ...
    onKeyUp : (Int -> msg) -> Attribute userText msg
    onKeyUp tagger =
